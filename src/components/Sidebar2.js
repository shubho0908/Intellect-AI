        ...
        <div className="middle-section w-full justify-between flex items-center">
          <Link
            ...
            className={`hover:bg-[#0266D9] ${
              pathname === "/" && "bg-[#0266D9]"
            } p-[.5rem] xsm:p-3 w-fit md:w-full md:py-3 md:px-6 rounded-lg transition-all flex items-center my-1`}
          >
          ...
          <div
            ...
            } p-[.5rem] xsm:p-3 w-fit md:w-full md:py-3 md:px-6 rounded-lg transition-all flex items-center justify-between my-1`}
            onClick={() => {
          ...
          <Link
            ...
            } p-[.5rem] xsm:p-3 w-fit md:w-full md:py-3 md:px-6 rounded-lg transition-all my-1`}
          >
